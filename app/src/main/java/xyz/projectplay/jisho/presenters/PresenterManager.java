...
public class PresenterManager {
    ...
    PresenterManager(long maxSize, long expirationValue, @NonNull TimeUnit expirationUnit) {
    ...
    @Nullable
    public <P extends BasePresenter<?, ?>> P restorePresenter(@NonNull Bundle savedInstanceState) {
    ...
    public void savePresenter(@NonNull BasePresenter<?, ?> presenter, @NonNull Bundle outState) {
